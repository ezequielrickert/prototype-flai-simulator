              ...
              {!feedback ? (
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <p className="text-[var(--cream)] text-center max-w-md mb-4" style={{lineHeight: '1.6'}}>
                    Mariana está preparando una reflexión personalizada basada en nuestra conversación. Esto puede tomar unos momentos.
                  </p>
                ...
                <div className="space-y-4">
                  <div className="bg-[var(--gray-dark)] p-6 rounded-lg border border-[#D4AF37] shadow-sm">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h3 className="font-bold text-xl text-[var(--cream)]" style={{color: '#D4AF37'}}>Reflexión de Mariana</h3>
                    </div>
            ...
            <div className="mt-12 pt-8 border-t border-[#D4AF37]">
              <div className="flex items-center justify-between">
                <div className="text-base text-[var(--cream)] font-medium">
                  <span className="font-bold">Mariana</span> • Coach de Ética Empresarial
                </div>
                <Button
                  onClick={onClose}
                  disabled={!feedback}
